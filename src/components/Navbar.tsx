...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/* Top utility bar */}
      <div style={{ backgroundColor: '#2d4055' }} className="text-white/80 text-xs py-2">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-1.5 sm:gap-0">
      ...
      <div className="bg-white shadow-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-3 flex-shrink-0">
            <img src={logo} alt="Hermau Services" className="h-12 sm:h-14 w-auto" />
            <div className="w-px h-10 bg-gray-200" />
            <img src={logo20} alt="20 Years of Quality Service" className="h-10 sm:h-12 w-auto" />
          </Link>
