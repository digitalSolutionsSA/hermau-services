...
export default function Home() {
  return (
    <>
      ...
      {/* Intro Strip */}
      <section className="bg-green-700 text-white py-8 px-4 text-center">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map(({ icon, title, desc, href }) => (
              <div key={title} className="text-center p-6 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="text-5xl mb-4">{icon}</div>
                <h3 className="text-xl font-semibold text-gray-800 mb-2">{title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed mb-4">{desc}</p>
                <Link to={href} className="text-green-700 font-medium text-sm hover:underline">
                  Learn more →
                </Link>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="rounded-lg overflow-hidden shadow-md group">
            ...
            <div className="p-6 bg-white">
              <h3 className="text-xl font-bold text-gray-800 mb-2">Garden Maintenance</h3>
              ...
              <Link to="/garden-maintenance" className="bg-green-700 text-white px-5 py-2 rounded text-sm font-medium hover:bg-green-600 transition-colors inline-block">
                Read More
              </Link>
            </div>
          </div>
          ...
          <div className="rounded-lg overflow-hidden shadow-md group">
            ...
            <div className="p-6 bg-white">
              <h3 className="text-xl font-bold text-gray-800 mb-2">Cleaning Services</h3>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">
              ...
              <Link to="/cleaning-services" className="bg-green-700 text-white px-5 py-2 rounded text-sm font-medium hover:bg-green-600 transition-colors inline-block">
                Read More
              </Link>
            </div>
          </div>
      ...
      >
        <div className="max-w-5xl mx-auto bg-white/95 rounded-xl shadow-lg overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="p-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-3">About Hermau Services</h2>
            ...
            <Link
              to="/about"
              className="bg-green-700 text-white px-6 py-2 rounded font-medium text-sm hover:bg-green-600 transition-colors inline-block"
            >
              Read More
            </Link>
          </div>
